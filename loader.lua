...
-- FPS Boost GUI (tetap dibuat tapi hidden dulu)
...
if HasAccess() then
    -- Animasi "Checking Key..." walau HWID valid
    local CheckingLabel = Instance.new("TextLabel", ScreenGui)
    CheckingLabel.AnchorPoint = Vector2.new(0.5,0.5)
    CheckingLabel.Position = UDim2.new(0.5,0,0.5,0)
    CheckingLabel.Size = UDim2.new(0,300,0,50)
    CheckingLabel.Text = "⏳ Checking Key..."
    CheckingLabel.TextColor3 = Color3.fromRGB(255,255,0)
    CheckingLabel.Font = Enum.Font.GothamBold
    CheckingLabel.TextScaled = true
    CheckingLabel.BackgroundTransparency = 1
    wait(1.5)
    CheckingLabel.Text = "✅ Key tersimpan, loading script..."
    CheckingLabel.TextColor3 = Color3.fromRGB(80,255,80)
    wait(1)
